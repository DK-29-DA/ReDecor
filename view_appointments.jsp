<%-- 
    ...
    Created on : Feb 5, 2022, 2:46:07 AM
    Author     : admin
--%>
...
<html>
    ...
    <div id="page" class="s-pagewrap">
        ...
        try{
         ...
         while(rs.next())
         {
         out.println("<tr><td>"+i+"</td><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+"</td><td>"+rs.getDate(5)+"</td><td>"+rs.getString(6)+"</td><td>"+rs.getString(7)+"</td></tr>");
         i++;
